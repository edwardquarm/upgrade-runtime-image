...
This repo provides `upgrade-runtime/upgrade-runtime.sh`, a helper script that scans
...
For the deprecated/removed runtime scanner, see `deprecated-and-removed-runtime/README.md`.

## Download

```bash
curl -fsSL https://raw.githubusercontent.com/edwardquarm/upgrade-runtime-image/main/upgrade-runtime/upgrade-runtime.sh -o upgrade-runtime.sh
